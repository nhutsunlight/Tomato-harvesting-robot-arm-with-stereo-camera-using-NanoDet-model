...
public:
    StereoCameraInfoNode() : Node("stereo_camera_info_node")
    {
        ...
        // Publishers
        left_camera_info_pub_ = this->create_publisher<sensor_msgs::msg::CameraInfo>("/stereo/left/camera_info_calib", rclcpp::QoS(rclcpp::KeepLast(1)).transient_local().reliable());
        right_camera_info_pub_ = this->create_publisher<sensor_msgs::msg::CameraInfo>("/stereo/right/camera_info_calib", rclcpp::QoS(rclcpp::KeepLast(1)).transient_local().reliable());
