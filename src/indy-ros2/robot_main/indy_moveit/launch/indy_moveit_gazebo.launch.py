...
def launch_setup(context, *args, **kwargs):
    ...
    #yolobot_recognition = FindPackageShare('yolobot_recognition')
    ...
    #yolobot_recognition_launch = IncludeLaunchDescription(
    #    PythonLaunchDescriptionSource(
    #        [yolobot_recognition, "/launch", "/launch_yolo.launch.py"]
    #    ),
    #)
