...
def launch_setup(context, *args, **kwargs):
    ...
    hmi_node = Node(
        package="hmi_launcher",
        executable="launcher_gui",
        name="hmi_node",
        output="screen",
        parameters=[
            {"use_sim_time": use_sim_time},
    ...
    visualize_py_node = Node(
        package="yolobot_recognition_py",
        executable="visualize_node",
        name="visualize_py_node",
        output="screen",
        parameters=[
            {"use_sim_time": use_sim_time},
            #{"use_sim_time": True},
    ...
    harvest_flag_node = Node(
        package="harvest_flag_bridge",
        executable="harvest_flag_bridge_node",
        name="harvest_flag_node",
        output="screen",
        parameters=[
            {"use_sim_time": use_sim_time},
            #{"use_sim_time": True},
