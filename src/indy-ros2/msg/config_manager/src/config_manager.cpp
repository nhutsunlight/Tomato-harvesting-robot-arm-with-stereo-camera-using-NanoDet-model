...
private:
    ...
    void loadAndPublish()
    {
        try {
            ...
            msg.drop_pose = setup["DropPose"].as<std::vector<double>>();
            ...
            msg.sgbm_wls_lambda = sgbm["wls_lambda"].as<int>();
            msg.sgbm_wls_sigma = sgbm["wls_sigma"].as<double>();
            ...
            msg.bm_wls_lambda = bm["wls_lambda"].as<int>();
            msg.bm_wls_sigma = bm["wls_sigma"].as<double>();
